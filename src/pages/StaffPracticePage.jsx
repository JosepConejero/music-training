...
export const StaffPracticePage = () => {
  ...
  const { value: isOneOctavePressed, updateToggleValue: updateIsOneOctavePressed } = useToggleValue(true);
    ...
    <div className="staff-practice-page-container">
      ...
      <main className="staff-practice">
        ...
        <div className="container-span">
          <button className="wide-button tall-60" onClick={() => playNote(activeNote)}>
            PLAY
          </button>
